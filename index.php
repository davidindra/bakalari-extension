    ...
    <form action="index.php" method="GET">
        <table border="0">
            <tr>
                ...
                <td><input type="number" name="zisk" style="width:50px" min="1" max="300"
                           value="<?php echo $_GET["zisk"]; ?>"> bodů
                </td>
            </tr>
            <tr>
                <td>Součet maximálních bodů z předmětu:</td>
                <td><input type="number" name="max" style="width:50px" min="1" max="300"
                           value="<?php echo $_GET["max"]; ?>"> bodů
                </td>
            </tr>
            <tr>
                <td>Písemka bude na</td>
                <td><input type="number" name="pisemka" style="width:50px" min="1" max="300"
                           value="<?php echo $_GET["pisemka"]; ?>"> bodů
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="submit"><input class="submit" type="submit" name="odeslat" value="Vypočítat">
                </td>
            </tr>
        </table>
    </form>
...
<?php if (!isset($_GET["odeslat"]) && strpos($_SERVER["HTTP_REFERER"], "baka") === FALSE) { ?>
    <center><br>
        <div style="width: 270px;padding:5px;background-color:#FFF47F;">
